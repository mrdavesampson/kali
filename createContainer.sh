#!/bin/bash
# NullBytes script to create encrypted container using 4096 bit key
# Will prompt the user to select a container name, key file name, mount point, and specify the container size
